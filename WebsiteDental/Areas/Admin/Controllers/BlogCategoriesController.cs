...
namespace WebsiteDental.Areas.Admin.Controllers
{
    ...
    public class BlogCategoriesController : Controller
    {
        ...
        public BlogCategoriesController(WebsiteDentalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,CategoryName,IsActive")] BlogCategory blogCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategoryName,IsActive")] BlogCategory blogCategory)
        {
