...
namespace WebsiteDental.Areas.Admin.Controllers
{
    ...
    public class FaqsController : Controller
    {
        ...
        public FaqsController(WebsiteDentalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Question,Answer,IsActive")] Faq faq)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Question,Answer,IsActive")] Faq faq)
        {
            if (id != faq.Id)
            {
                return NotFound();
